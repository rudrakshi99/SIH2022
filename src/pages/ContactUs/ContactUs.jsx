                ...
                <div className='flex-1'>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="w-full mt-12 max-w-lg">
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full md:w-2/5 mr-3 border border-green-100 px-3 mb-6 md:mb-0">
                            ...
                            <div className="w-full md:w-2/5 ml-3 border border-green-100 px-3">
                            ...
                            <div className="w-full md:w-2/5 mt-3 mr-3 px-3 mb-6 border border-green-100 md:mb-0">
                            ...
                            <div className="w-full md:w-2/5 ml-3 mt-3 px-3 border border-green-100 mb-6 md:mb-0">
                            ...
                            <div className="w-full h-20 md:w-4/5 mt-3 border border-green-100 px-3 mb-6 md:mb-0">

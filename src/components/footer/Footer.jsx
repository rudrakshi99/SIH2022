            ...
            <div className='flex justify-center items-center'>
                <div className='flex-1 border-r-2 border-black-600'>
                    <div className='flex justify-center items-center mx-8 cursor-pointer' onClick={() => navigate('/')}>
                        ...
                        <div className='ml-4'>
                            ...
                            <p className='text-md font-normal text-white mt-2'>Kisaan upkaran ka ek Matra Sadhan.</p>
                        </div>
                    </div>
                </div>
                <div className='flex-1 px-16 border-r-2 border-black-600'>
                    <div className='flex'>
                        ...
                        <ul>
                            <li className='text-lg text-white font-bold cursor-pointer' onClick={() => navigate('/support-center')}>Support Center</li>
                            <li className='text-lg text-white font-medium cursor-pointer' onClick={() => navigate('help')}>Help Center</li>
                    ...
                    <p className='text-md text-medium text-white mt-4'>Please provide us Feedback <a className='text-white pb-2 text-xl underline' href="/feedback">here</a></p>
                </div>
                <div className='flex-1 px-16 border-r-2 border-black-600'>
                    ...
                    <div className='flex my-5 justify-left'>
                        <img className='socialIcons mx-3 ml-6 cursor-pointer' src={Vector} alt="" />
                        <img className='socialIcons mx-3 ml-6 cursor-pointer' src={Vector1} alt="" />
                        <img className='socialIcons mx-3 ml-6 cursor-pointer' src={Vector2} alt="" />
                    </div>
                    <p className='text-lg ml-6 text-white'>Made by : <strong>Team Gryffindor</strong></p>
                </div>
